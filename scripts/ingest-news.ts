...
const PENDING_NEWS: Array<{
  ...
  {
    title: "O amigo do crime",
    source_name: "piauí",
    source_url: "https://piaui.uol.com.br/revista/237/o-amigo-do-crime-ciro-nogueira/",
    published_at: "2026-06-02",
    summary: "Perfil mostra por que o senador Ciro Nogueira aparece recorrentemente em escândalos da República, incluindo a relação com Daniel Vorcaro, mesadas e viagens de luxo bancadas pelo banqueiro do Master.",
    election_name: "Senador Piaui 2026",
    candidate_names: ["Ciro Nogueira"],
    status: "published",
  },
  {
    title: "Jaques Wagner e as conexões baianas do Master",
    source_name: "piauí",
    source_url: "https://piaui.uol.com.br/web/jaques-wagner-e-as-conexoes-baianas-do-master/",
    published_at: "2026-06-18",
    summary: "Alvo de operação da Polícia Federal, o senador Jaques Wagner e o empresário Augusto Lima teriam ajudado a criar, com o Credcesta, uma mina de ouro para Daniel Vorcaro na Bahia.",
  ...
  },
  {
    ...
    source_name: "piauí",
    source_url: "https://piaui.uol.com.br/revista/233/o-banco-master-e-a-desmoralizacao-da-republica/",
    published_at: "2026-02-02",
    summary: "Reportagem mapeia como a rede de influência do Banco Master contaminou instituições da República, incluindo a compra de ativos do Master pelo BRB, o banco estatal do Distrito Federal, sob o governo de Ibaneis Rocha.",
