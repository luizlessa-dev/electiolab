...
const PENDING_POLLS: Array<{
  ...
  // Fonte: https://www.cnnbrasil.com.br/eleicoes/verita-flavio-tem-485-no-2o-turno-lula-431/
  {
    ...
    results: [
      { candidate_name: "Flavio Bolsonaro", percentage: 48.5 },
  ...
  // Amapá: https://www.poder360.com.br/poder-eleicoes-2026/flavio-tem-45-contra-41-de-lula-no-2o-turno-no-ap-diz-pesquisa/
  {
    ...
    scenario_label: "Flávio vs Lula",
    results: [
      { candidate_name: "Flavio Bolsonaro", percentage: 45.0 },
