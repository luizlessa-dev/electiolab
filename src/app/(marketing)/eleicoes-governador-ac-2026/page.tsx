...
const webPageJsonLd = {
  ...
  "@type": "WebPage",
  "@id": "https://electiolab.com/eleicoes-governador-ac-2026",
  "url": "https://electiolab.com/eleicoes-governador-ac-2026",
...
export default async function GovernadorAC2026Page() {
  const snapshot = await getLatestStateGovPoll("AC");
  return (
...
<script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"ElectioLab","item":"https://electiolab.com"},{"@type":"ListItem","position":2,"name":"Eleições 2026","item":"https://electiolab.com/eleicoes"},{"@type":"ListItem","position":3,"name":"Governador Acre 2026","item":"https://electiolab.com/eleicoes-governador-ac-2026"}]}) }}
      />      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(faqJsonLd) }} />
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(buildStateRaceDataset({ uf: "AC", race: "governador", url: "https://electiolab.com/eleicoes-governador-ac-2026", snapshot })) }} />
