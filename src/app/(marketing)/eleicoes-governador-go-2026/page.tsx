...
const webPageJsonLd = {
  ...
  "@type": "WebPage",
  "@id": "https://electiolab.com/eleicoes-governador-go-2026",
  "url": "https://electiolab.com/eleicoes-governador-go-2026",
...
export default async function GovernadorGO2026Page() {
  const snapshot = await getLatestStateGovPoll("GO");
  return (
...
<script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"ElectioLab","item":"https://electiolab.com"},{"@type":"ListItem","position":2,"name":"Eleições 2026","item":"https://electiolab.com/eleicoes"},{"@type":"ListItem","position":3,"name":"Governador Goiás 2026","item":"https://electiolab.com/eleicoes-governador-go-2026"}]}) }}
      />      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(faqJsonLd) }} />
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(buildStateRaceDataset({ uf: "GO", race: "governador", url: "https://electiolab.com/eleicoes-governador-go-2026", snapshot })) }} />
